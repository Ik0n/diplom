                    ...
                    <div class="panel panel-default" style="">
                        ...
                        <div class="form-horizontal">
                            <div class="form-group">
                                {{ Form::model(null, ['files' => true, 'method' => 'POST', 'route' => ['dialogStore',$user->name,] ]) }}
                            </div>
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                <div class="col-md-12 col-md-offset1">
                                    {{ Form::label('dialog_participants', 'dialog_participants') }}
                                </div>
                                <div class="col-md-12 col-md-offset1">
                                    {{ Form::select('dialog_participants[]', $friends, null, ['multiple']) }}
                                </div>
                            </div>
                            <div class="form-group">
